...
var databaseName = env.String("DatabaseName", false, "titanic", "The database name for monfodb")
...
func NewDataContext() (DataContext, error) {
	...
	dataContext.DocumentRepository = newDocumentRepository(client, *databaseName)
